package com.dxc.bookshelf.user.config;
...
public class SwaggerConfig {
    ...
    public Docket productApi() {
    	return new Docket(DocumentationType.SWAGGER_2).select().apis(RequestHandlerSelectors.basePackage("com.dxc.bookshelf.user.controller")).paths(regex("/api/v1/user.*")).build();
    }
}
